...
public class KB2 extends Activity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        adapter = new ArrayAdapter<String>(getApplicationContext(),android.R.layout.simple_spinner_item,m);
        //设置下拉列表的风格
                ...
                AlertDialog dialog = new AlertDialog.Builder(getApplicationContext())
                        ...
                        .setPositiveButton("确定", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                Toast.makeText(getApplicationContext(),"表信息已清除", Toast.LENGTH_SHORT).show();
                                getID();
                                getCookie();
                            }
                        }).create();
    ...
    private void getID() {
        ...
        if(xuehao.length()==0){
            Toast.makeText(getApplicationContext(),"你还没有输入账号", Toast.LENGTH_SHORT).show();
        }
            ...
            public void run() {
                try {
                    ...
                    if (str != null){
                        ...
                        Toast.makeText(getApplicationContext(),"获取Cookies失败",Toast.LENGTH_SHORT);
                    }
        ...
        public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
            ...
            switch ((int) spinner.getItemIdAtPosition(position)){
                ...
                case 1:
                    WeekNum =2;
                    showResponse(WeekNum);
                    Toast.makeText(getApplicationContext(), "第2周", Toast.LENGTH_SHORT).show();
                    break;
                case 2:
                    WeekNum =3;
                    showResponse(WeekNum);
                    Toast.makeText(getApplicationContext(), "第3周", Toast.LENGTH_SHORT).show();
                    break;
                case 3:
                    WeekNum =4;
                    showResponse(WeekNum);
                    Toast.makeText(getApplicationContext(), "第4周", Toast.LENGTH_SHORT).show();
                    break;
                case 4:
                    WeekNum =5;
                    showResponse(WeekNum);
                    Toast.makeText(getApplicationContext(), "第5周", Toast.LENGTH_SHORT).show();
                    break;
                case 5:
                    WeekNum =6;
                    showResponse(WeekNum);
                    Toast.makeText(getApplicationContext(), "第6周", Toast.LENGTH_SHORT).show();
                    break;
                case 6:
                    WeekNum =7;
                    showResponse(WeekNum);
                    Toast.makeText(getApplicationContext(), "第7周", Toast.LENGTH_SHORT).show();
                    break;
                case 7:
                    WeekNum =8;
                    showResponse(WeekNum);
                    Toast.makeText(getApplicationContext(), "第8周", Toast.LENGTH_SHORT).show();
                    break;
                case 8:
                    WeekNum =9;
                    showResponse(WeekNum);
                    Toast.makeText(getApplicationContext(), "第9周", Toast.LENGTH_SHORT).show();
                    break;
                case 9:
                    WeekNum =10;
                    showResponse(WeekNum);
                    Toast.makeText(getApplicationContext(), "第10周", Toast.LENGTH_SHORT).show();
                    break;
                case 10:
                    WeekNum =11;
                    showResponse(WeekNum);
                    Toast.makeText(getApplicationContext(), "第11周", Toast.LENGTH_SHORT).show();
                    break;
                case 11:
                    WeekNum =12;
                    showResponse(WeekNum);
                    Toast.makeText(getApplicationContext(), "第12周", Toast.LENGTH_SHORT).show();
                    break;
                case 12:
                    WeekNum =13;
                    showResponse(WeekNum);
                    Toast.makeText(getApplicationContext(), "第13周", Toast.LENGTH_SHORT).show();
                    break;
                case 13:
                    WeekNum =14;
                    showResponse(WeekNum);
                    Toast.makeText(getApplicationContext(), "第14周", Toast.LENGTH_SHORT).show();
                    break;
                case 14:
                    WeekNum =15;
                    showResponse(WeekNum);
                    Toast.makeText(getApplicationContext(), "第15周", Toast.LENGTH_SHORT).show();
                    break;
                case 15:
                    WeekNum =16;
                    showResponse(WeekNum);
                    Toast.makeText(getApplicationContext(), "第16周", Toast.LENGTH_SHORT).show();
                    break;
                case 16:
                    WeekNum =17;
                    showResponse(WeekNum);
                    Toast.makeText(getApplicationContext(), "第17周", Toast.LENGTH_SHORT).show();
                    break;
                case 17:
                    WeekNum =18;
                    showResponse(WeekNum);
                    Toast.makeText(getApplicationContext(), "第18周", Toast.LENGTH_SHORT).show();
                    break;
                case 18:
                    WeekNum =19;
                    showResponse(WeekNum);
                    Toast.makeText(getApplicationContext(), "第19周", Toast.LENGTH_SHORT).show();
                    break;
                case 19:
                    WeekNum =20;
                    showResponse(WeekNum);
                    Toast.makeText(getApplicationContext(), "第20周", Toast.LENGTH_SHORT).show();
                    break;
                case 20:
                    WeekNum =0;
                    showResponse(WeekNum);
                    Toast.makeText(getApplicationContext(), "总课表", Toast.LENGTH_SHORT).show();
                    break;
                default:
                    break;
            }
