...
public class i_scFragment extends LazyLoadFragment {
			...
			public void run() {
				try {
					...
					Request request4 = new Request.Builder()
							// 安全教育
							.url("http://sc.sit.edu.cn/public/activity/activityList.action?categoryId=402881de5d62ba57015d6320f1a7000c")
