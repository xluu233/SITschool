...
public class KB  extends Activity implements View.OnClickListener {
    WebView wb;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        Button zong = (Button)findViewById(R.id.zong);
        Button bt1 = (Button)findViewById(R.id.zhou1);
        Button bt2 = (Button)findViewById(R.id.zhou2);
        Button bt3 = (Button)findViewById(R.id.zhou3);
        Button bt4 = (Button)findViewById(R.id.zhou4);
        Button bt5 = (Button)findViewById(R.id.zhou5);
        Button bt6 = (Button)findViewById(R.id.zhou6);
        Button bt7 = (Button)findViewById(R.id.zhou7);
        Button bt8 = (Button)findViewById(R.id.zhou8);
        Button bt9 = (Button)findViewById(R.id.zhou9);
        Button bt10 = (Button)findViewById(R.id.zhou10);
        Button bt11 = (Button)findViewById(R.id.zhou11);
        Button bt12 = (Button)findViewById(R.id.zhou12);
        Button bt13 = (Button)findViewById(R.id.zhou13);
        Button bt14 = (Button)findViewById(R.id.zhou14);
        Button bt15 = (Button)findViewById(R.id.zhou15);
        Button bt16 = (Button)findViewById(R.id.zhou16);
        Button bt17 = (Button)findViewById(R.id.zhou17);
        Button bt18 = (Button)findViewById(R.id.zhou18);
        Button bt19 = (Button)findViewById(R.id.zhou19);
        Button bt20= (Button)findViewById(R.id.zhou20);
