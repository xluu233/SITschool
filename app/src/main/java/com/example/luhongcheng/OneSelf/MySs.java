...
public class MySs extends AppCompatActivity {
    ...
    private void initData2() {
        BmobQuery<com.example.luhongcheng.Bmob_bean.SS> find_myself = new BmobQuery<>();
        find_myself.addWhereEqualTo("ID", you_id);
        find_myself.order("-createdAt");
        find_myself.setLimit(100);
        find_myself.findObjects(new FindListener<com.example.luhongcheng.Bmob_bean.SS>(){
            @Override
            public void done(List<com.example.luhongcheng.Bmob_bean.SS> list, BmobException e) {
